...
public partial class WelcomeViewModel : ObservableObject
{
    ...
    public Color ViBackground => SelectedLanguage == "vi" ? Colors.White : Color.FromArgb("#00000000");
    public Color EnBackground => SelectedLanguage == "en" ? Colors.White : Color.FromArgb("#00000000");
    public Color KoBackground => SelectedLanguage == "ko" ? Colors.White : Color.FromArgb("#00000000");

    // Màu chữ button: cam (Primary) nếu được chọn, trắng nếu không
    public Color ViTextColor => SelectedLanguage == "vi" ? Color.FromArgb("#FF6B35") : Colors.White;
    public Color EnTextColor => SelectedLanguage == "en" ? Color.FromArgb("#FF6B35") : Colors.White;
    public Color KoTextColor => SelectedLanguage == "ko" ? Color.FromArgb("#FF6B35") : Colors.White;

    // Text trên màn hình tự đổi theo ngôn ngữ chọn
    public string Tagline => SelectedLanguage switch
    {
    ...
    public string FeatureLocation => SelectedLanguage switch
    {
    ...
    public string FeatureAudio => SelectedLanguage switch
    {
    ...
    public string FeatureQR => SelectedLanguage switch
    {
    ...
    public string GetStartedText => SelectedLanguage switch
    {
        "en" => "START EXPLORING",
        "ko" => "탐험 시작하기",
        _ => "BẮT ĐẦU KHÁM PHÁ"
